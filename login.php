...
<td align="right"><img src="image-slider/images/bsnl.jpg" height="100" width="100"/></td>
	...
	<meta name="author" content="Mohammad Akram Ali" />
	<meta name="robots" content="all" />
	<meta name="description" content="How to create tabs in HTML using jQuery" />
	<meta name="keywords" content="create tabs in HTML, jQuery tabs" />
	<!-- Style Sheets -->
...
<body>
	<div class="mainContainer">
		...
		<form name="login" action="login_check.php" method="post">
			<table border="0">
			<tr>
			<td colspan="2" align="center"><div><h2 class="title">Sign In</h2></div></td></tr>
				<tr>
				<td>Email:</td>
