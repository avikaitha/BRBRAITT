<?php
    ...
    if(!$db){
        ...
        $qry1='SELECT * FROM USERS WHERE EMAILID =\''.$email.'\'';
    ...
    <td>';
        ...
        <td align="right"><a href=register.php?key='.$courseid1.'>register</a></td>
        </tr>
        <tr>
    ...
    else
    {
        ...
        <a href="signup.php" class="brbraitt-header-link brbraitt-header-link-special">Sign Up</a></div></div></div>
